...
export function Preloader() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Kinetic Secondary Logomark Wrapper (responsive scaling, safe bounds prevent clipping) */}
        <div className="relative w-28 h-24 sm:w-36 sm:h-28 md:w-40 md:h-32 flex items-center justify-center overflow-visible svg-mark-wrapper">
          <svg
            viewBox="-40 -60 740 600"
            className="w-full h-full drop-shadow-[0_0_24px_rgba(208,233,103,0.35)] overflow-visible"
            fill="none"
