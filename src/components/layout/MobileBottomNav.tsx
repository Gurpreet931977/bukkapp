    ...
    >
      ...
      <div className="max-w-md mx-auto px-2 py-1.5">
        <div className="relative">
          ...
          {activeIndex >= 0 && (
            <div
              className="absolute inset-y-0 pointer-events-none transition-transform duration-300 ease-[cubic-bezier(0.34,1.4,0.64,1)] motion-reduce:transition-none will-change-transform"
              style={{
                width: '20%',
            ...
            >
              <div className="mx-1 h-full rounded-[18px] bg-brand-black text-white shadow-[0_4px_16px_rgba(0,0,0,0.18)] relative overflow-hidden flex flex-col items-center justify-between py-1">
                {/* Centered High-Voltage Electric Lime Active Top Beam */}
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-8 h-[2.5px] rounded-full bg-[#D0E967] shadow-[0_0_8px_rgba(208,233,103,0.8)]" />
              </div>
            </div>
          )}
