...
export default function BusinessReviewsPage() {
  ...
  const [reviews, setReviews] = useState<Review[]>(() => {
    ...
    return activeBiz ? store.getReviewsByBusinessId(activeBiz.id) : [];
  });
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          {reviews.length > 0 ? (
            ...
            <div className="text-center py-16 bg-white rounded-2xl border border-brand-border p-6 space-y-2">
              <MessageSquare className="w-10 h-10 text-neutral-300 mx-auto" />
              <h3 className="text-base font-bold text-brand-black">No reviews yet</h3>
              <p className="text-xs text-brand-secondary max-w-sm mx-auto leading-relaxed">
                When customers complete verified appointments through your BUKKAPP storefront, their ratings and reviews will appear here.
              </p>
            </div>
          )}
        </div>
